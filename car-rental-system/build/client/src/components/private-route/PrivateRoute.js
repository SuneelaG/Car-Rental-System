...
var PrivateRoute = function (_a) {
    ...
    return (react_1.default.createElement(react_router_dom_1.Route, __assign({}, rest, { render: function (props) {
            return user.isAuthenticated === true ? (react_1.default.createElement(Component, __assign({}, props))) : (react_1.default.createElement(react_router_dom_1.Redirect, { to: "/login" }));
        } })));
};
